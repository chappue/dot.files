...
(defface mark-whitespace-face
  ...
  nil
  :group 'face)
(defvar trailing-whitespace 'trailing-whitespace)
...
(defadvice font-lock-mode (before my-font-lock-mode ())
  (font-lock-add-keywords
   ...
   '(
     ...
     ("Å@" 0 mark-whitespace-face append)
...
(defun color-theme-charcoal-black ()
  ...
  (color-theme-install
   '(color-theme-charcoal-black
     ...
     (trailing-whitespace ((t (:underline "MediumBlue"))))
     ...
     ;; anything
     (anything-candidate-number ((t (:background "dark slate gray"))))

     ;; org-mode
     (org-level-3 ((t (:foreground "DarkGoldenrod3")))))))
